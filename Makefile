...
BASE_COMMIT=b14928a1fb337cc29eeffac0445cfdbe2a6efb00
dist:
	rm -rf grafana-dist
...
build_from_dist: dist
	./build.sh public/build/static/source_$(shell git rev-parse HEAD).tar.gz 10-ubi8-10.3.12-11

push_from_dist: build_from_dist
	docker push ghcr.io/goldmansachs/grafana:10-ubi8-10.3.12-11
